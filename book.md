...
>(2) 제어기, 서보 보드 1set(3축이상의 부가축 적용시), 부가축 AMP, 각종 신호용 케이블 준비  
>(3) 부가축 정수  
...
* 축수에 따른 서보보드와 AMP의 조합은 다음과 같습니다.
  ...
  | 축 구성 | BD/AMP 구성 |
  | :------------------: | :-------------------: |
    | 1축 \~ 6축</br>(기본6축) | 서보 보드 1개</br>6축 AMP 1개 |
  | 7축 \~ 8축</br>(기본6축 + 부가2축) | 서보 보드 1개</br>6축 AMP 1개</br>1축 AMP 1~2개 |
  | 9축 ~ 12축</br>(기본6축 + 부가6축) | 서보 보드 2개</br>6축 AMP 2개 |
  | 13축 ~ 16축</br>(기본6축 + 부가12축) | 서보 보드 2개</br>6축 AMP 2개</br>1축 AMP 1~4개 |
